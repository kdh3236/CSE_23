...
/* compute sqrt(a*a + b*b) without overflow/underflow */
#include <math.h>
float pythag(float a, float b)
{
	...
	if (absa > absb) {
		float r = absb / absa;
		return absa * sqrtf(1.0f + r * r);
	} else if (absb != 0.0f) {
		float r = absa / absb;
		return absb * sqrtf(1.0f + r * r);
	} else
		return 0.0f;
}
...
#else /* K&R */
/* compute sqrt(a*a + b*b) without overflow/underflow for K&R */
#include <math.h>
float pythag(a,b)
float a,b;
{
