...
void MEMORY::load(string inst_file) {
...
void MEMORY::imemAccess(uint32_t addr, uint32_t *inst) {
...
void MEMORY::dmemAccess(uint32_t addr, uint32_t *read_data, uint32_t write_data, uint32_t MemRead, uint32_t MemWrite) {
