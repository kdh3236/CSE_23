...
main(int argc, char *argv[])
{
  ...
  40:	8f458593          	addi	a1,a1,-1804 # 930 <thread_join+0x3c>
  44:	4509                	li	a0,2
  ...
  56:	8f658593          	addi	a1,a1,-1802 # 948 <thread_join+0x54>
  5a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	5b450513          	addi	a0,a0,1460 # 970 <digits>
 3c4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 656:	31eb8b93          	addi	s7,s7,798 # 970 <digits>
 ...
 6a4:	2c890913          	addi	s2,s2,712 # 968 <thread_join+0x74>
        for(; *s; s++)
...
thread_create(void (*start_routine)(void*, void*), void *arg1, void* arg2)
{
 ...
 8ba:	ef3ff0ef          	jal	7ac <malloc>
    if (stack == 0) return -1;
 8be:	c90d                	beqz	a0,8f0 <thread_create+0x4c>
 ...
 8c8:	85ce                	mv	a1,s3
 8ca:	854a                	mv	a0,s2
 8cc:	aa5ff0ef          	jal	370 <clone>
 8d0:	00054a63          	bltz	a0,8e4 <thread_create+0x40>
 ...
 8e2:	8082                	ret
        free(stack);
 8e4:	8526                	mv	a0,s1
 8e6:	e45ff0ef          	jal	72a <free>
        return -1;
 8ea:	557d                	li	a0,-1
 8ec:	64e2                	ld	s1,24(sp)
 8ee:	b7e5                	j	8d6 <thread_create+0x32>
    if (stack == 0) return -1;
 8f0:	557d                	li	a0,-1
 8f2:	b7d5                	j	8d6 <thread_create+0x32>

00000000000008f4 <thread_join>:
...
{   
 ...
 8fc:	1800                	addi	s0,sp,48
    ...
    if ((tid = join(&stack)) < 0) {
 8fe:	fd840513          	addi	a0,s0,-40
 902:	a77ff0ef          	jal	378 <join>
 906:	00054d63          	bltz	a0,920 <thread_join+0x2c>
 90a:	84aa                	mv	s1,a0
        return -1;
    }

    free(stack);
 90c:	fd843503          	ld	a0,-40(s0)
 910:	e1bff0ef          	jal	72a <free>
    return tid;
}
 914:	8526                	mv	a0,s1
 ...
 91e:	8082                	ret
        return -1;
 920:	54fd                	li	s1,-1
 922:	bfcd                	j	914 <thread_join+0x20>
