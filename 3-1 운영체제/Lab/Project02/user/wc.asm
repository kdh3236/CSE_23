...
wc(int fd, char *name)
{
  ...
  3c:	9e8a0a13          	addi	s4,s4,-1560 # a20 <thread_join+0x36>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	9a250513          	addi	a0,a0,-1630 # a40 <thread_join+0x56>
  ...
  cc:	96850513          	addi	a0,a0,-1688 # a30 <thread_join+0x46>
...
main(int argc, char *argv[])
{
 ...
 136:	8f658593          	addi	a1,a1,-1802 # a28 <thread_join+0x3e>
 13a:	4501                	li	a0,0
 ...
 14e:	90650513          	addi	a0,a0,-1786 # a50 <thread_join+0x66>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b6:	5be50513          	addi	a0,a0,1470 # a70 <digits>
 4ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 74c:	328b8b93          	addi	s7,s7,808 # a70 <digits>
 ...
 79a:	2d290913          	addi	s2,s2,722 # a68 <thread_join+0x7e>
        for(; *s; s++)
...
000000000000099a <thread_create>:
...
thread_create(void (*start_routine)(void*, void*), void *arg1, void* arg2)
{
 ...
 9ae:	6509                	lui	a0,0x2
 9b0:	ef3ff0ef          	jal	8a2 <malloc>
    if (stack == 0) return -1;
 9b4:	c90d                	beqz	a0,9e6 <thread_create+0x4c>
 9b6:	ec26                	sd	s1,24(sp)
 9b8:	84aa                	mv	s1,a0
 ...
 9be:	85ce                	mv	a1,s3
 9c0:	854a                	mv	a0,s2
 9c2:	aa5ff0ef          	jal	466 <clone>
 9c6:	00054a63          	bltz	a0,9da <thread_create+0x40>
 ...
 9d8:	8082                	ret
        free(stack);
 9da:	8526                	mv	a0,s1
 9dc:	e45ff0ef          	jal	820 <free>
        return -1;
 9e0:	557d                	li	a0,-1
 9e2:	64e2                	ld	s1,24(sp)
 9e4:	b7e5                	j	9cc <thread_create+0x32>
    if (stack == 0) return -1;
 9e6:	557d                	li	a0,-1
 9e8:	b7d5                	j	9cc <thread_create+0x32>

00000000000009ea <thread_join>:
...
{   
 ...
 9f8:	a77ff0ef          	jal	46e <join>
 9fc:	00054d63          	bltz	a0,a16 <thread_join+0x2c>
 a00:	84aa                	mv	s1,a0
        return -1;
    }
 ...
 a12:	6145                	addi	sp,sp,48
 a14:	8082                	ret
        return -1;
 a16:	54fd                	li	s1,-1
 a18:	bfcd                	j	a0a <thread_join+0x20>
