...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	23e58593          	addi	a1,a1,574 # 1250 <thread_join+0x30>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	20c58593          	addi	a1,a1,524 # 1260 <thread_join+0x40>
      5c:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1e650513          	addi	a0,a0,486 # 1268 <thread_join+0x48>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2be70713          	addi	a4,a4,702 # 1368 <thread_join+0x148>
    ...
    panic("runcmd");
      ...
      c6:	1ae50513          	addi	a0,a0,430 # 1270 <thread_join+0x50>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	19c58593          	addi	a1,a1,412 # 1278 <thread_join+0x58>
      e4:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     114:	17858593          	addi	a1,a1,376 # 1288 <thread_join+0x68>
     118:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     176:	12650513          	addi	a0,a0,294 # 1298 <thread_join+0x78>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	df4a8a93          	addi	s5,s5,-524 # 12c0 <thread_join+0xa0>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	dc250513          	addi	a0,a0,-574 # 12a0 <thread_join+0x80>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d2e60613          	addi	a2,a2,-722 # 12c8 <thread_join+0xa8>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d1eb0b13          	addi	s6,s6,-738 # 12e8 <thread_join+0xc8>
  ...
  return ret;
     ...
     5f8:	cdc50513          	addi	a0,a0,-804 # 12d0 <thread_join+0xb0>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c9250513          	addi	a0,a0,-878 # 12d8 <thread_join+0xb8>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c6c60613          	addi	a2,a2,-916 # 12f0 <thread_join+0xd0>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c18a0a13          	addi	s4,s4,-1000 # 12f8 <thread_join+0xd8>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	bf660613          	addi	a2,a2,-1034 # 1300 <thread_join+0xe0>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b6860613          	addi	a2,a2,-1176 # 12c8 <thread_join+0xa8>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b9460613          	addi	a2,a2,-1132 # 1318 <thread_join+0xf8>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b4e50513          	addi	a0,a0,-1202 # 1308 <thread_join+0xe8>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b5a50513          	addi	a0,a0,-1190 # 1320 <thread_join+0x100>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b9270713          	addi	a4,a4,-1134 # 1380 <thread_join+0x160>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9de60613          	addi	a2,a2,-1570 # 1258 <thread_join+0x38>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a9058593          	addi	a1,a1,-1392 # 1338 <thread_join+0x118>
     8b0:	4509                	li	a0,2
     8b2:	748000ef          	jal	ffa <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a1a50513          	addi	a0,a0,-1510 # 12d0 <thread_join+0xb0>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8d6:	a7648493          	addi	s1,s1,-1418 # 1348 <thread_join+0x128>
     8da:	4589                	li	a1,2
     8dc:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     970:	9e458593          	addi	a1,a1,-1564 # 1350 <thread_join+0x130>
     974:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     cec:	6b050513          	addi	a0,a0,1712 # 1398 <digits>
     cf0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f82:	41ab8b93          	addi	s7,s7,1050 # 1398 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     fd0:	39490913          	addi	s2,s2,916 # 1360 <thread_join+0x140>
        for(; *s; s++)
...
00000000000011d0 <thread_create>:
...
{
    11d0:	7179                	addi	sp,sp,-48
    11d2:	f406                	sd	ra,40(sp)
    11d4:	f022                	sd	s0,32(sp)
    11d6:	e84a                	sd	s2,16(sp)
    11d8:	e44e                	sd	s3,8(sp)
    11da:	e052                	sd	s4,0(sp)
    11dc:	1800                	addi	s0,sp,48
    11de:	892a                	mv	s2,a0
    11e0:	89ae                	mv	s3,a1
    11e2:	8a32                	mv	s4,a2
    int tid;
    ...
    11e4:	6509                	lui	a0,0x2
    11e6:	ef3ff0ef          	jal	10d8 <malloc>
    if (stack == 0) return -1;
    11ea:	c90d                	beqz	a0,121c <thread_create+0x4c>
    ...
    11f4:	85ce                	mv	a1,s3
    11f6:	854a                	mv	a0,s2
    11f8:	aa5ff0ef          	jal	c9c <clone>
    11fc:	00054a63          	bltz	a0,1210 <thread_create+0x40>
    1200:	64e2                	ld	s1,24(sp)
        free(stack);
        return -1;
    }
    ...
    1204:	7402                	ld	s0,32(sp)
    1206:	6942                	ld	s2,16(sp)
    1208:	69a2                	ld	s3,8(sp)
    120a:	6a02                	ld	s4,0(sp)
    120c:	6145                	addi	sp,sp,48
    120e:	8082                	ret
        free(stack);
    1210:	8526                	mv	a0,s1
    1212:	e45ff0ef          	jal	1056 <free>
        return -1;
    1216:	557d                	li	a0,-1
    1218:	64e2                	ld	s1,24(sp)
    121a:	b7e5                	j	1202 <thread_create+0x32>
    if (stack == 0) return -1;
    121c:	557d                	li	a0,-1
    121e:	b7d5                	j	1202 <thread_create+0x32>

0000000000001220 <thread_join>:

int 
thread_join()
{   
    1220:	7179                	addi	sp,sp,-48
    1222:	f406                	sd	ra,40(sp)
    1224:	f022                	sd	s0,32(sp)
    1226:	ec26                	sd	s1,24(sp)
    1228:	1800                	addi	s0,sp,48
    int tid;
    void *stack;
    
    if ((tid = join(&stack)) < 0) {
    122a:	fd840513          	addi	a0,s0,-40
    122e:	a77ff0ef          	jal	ca4 <join>
    1232:	00054d63          	bltz	a0,124c <thread_join+0x2c>
    1236:	84aa                	mv	s1,a0
        return -1;
    }

    free(stack);
    1238:	fd843503          	ld	a0,-40(s0)
    123c:	e1bff0ef          	jal	1056 <free>
    return tid;
}
    1240:	8526                	mv	a0,s1
    1242:	70a2                	ld	ra,40(sp)
    1244:	7402                	ld	s0,32(sp)
    1246:	64e2                	ld	s1,24(sp)
    1248:	6145                	addi	sp,sp,48
    124a:	8082                	ret
        return -1;
    124c:	54fd                	li	s1,-1
    124e:	bfcd                	j	1240 <thread_join+0x20>
