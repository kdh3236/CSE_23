...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a0:	4fc50513          	addi	a0,a0,1276 # 898 <digits>
 3a4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 636:	266b8b93          	addi	s7,s7,614 # 898 <digits>
