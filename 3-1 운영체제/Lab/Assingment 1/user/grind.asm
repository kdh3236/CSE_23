...
go(int which_child)
{
  ...
  int fd = -1;
    ...
    int what = rand() % 23;
     ...
     2fe:	0e1000ef          	jal	bde <sbrk>
     302:	b521                	j	10a <go+0x96>
    } else if(what == 16){
      if(sbrk(0) > break0)
     304:	4501                	li	a0,0
     306:	0d9000ef          	jal	bde <sbrk>
     30a:	e0aaf0e3          	bgeu	s5,a0,10a <go+0x96>
        sbrk(-(sbrk(0) - break0));
     30e:	4501                	li	a0,0
     310:	0cf000ef          	jal	bde <sbrk>
     314:	40aa853b          	subw	a0,s5,a0
     318:	0c7000ef          	jal	bde <sbrk>
