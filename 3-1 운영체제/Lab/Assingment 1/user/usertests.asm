...
0000000000001eca <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    1ed6:	43b020ef          	jal	4b10 <sbrk>
  uint64 top = (uint64) sbrk(0);
    1eda:	4501                	li	a0,0
    1edc:	435020ef          	jal	4b10 <sbrk>
  if((top % PGSIZE) != 0){
    1ee0:	03451793          	slli	a5,a0,0x34
    1ee4:	e7bd                	bnez	a5,1f52 <copyinstr3+0x88>
  top = (uint64) sbrk(0);
    1ee6:	4501                	li	a0,0
    1ee8:	429020ef          	jal	4b10 <sbrk>
  if(top % PGSIZE){
...
00000000000020d4 <sbrkbasic>:
{
  ...
  c = sbrk(1);
    21a8:	4505                	li	a0,1
    21aa:	167020ef          	jal	4b10 <sbrk>
  c = sbrk(1);
    21ae:	4505                	li	a0,1
    21b0:	161020ef          	jal	4b10 <sbrk>
  if(c != a + 1){
...
0000000000002216 <sbrkmuch>:
{
  ...
  oldbrk = sbrk(0);
    2228:	4501                	li	a0,0
    222a:	0e7020ef          	jal	4b10 <sbrk>
    222e:	892a                	mv	s2,a0
  a = sbrk(0);
    2230:	4501                	li	a0,0
    2232:	0df020ef          	jal	4b10 <sbrk>
    2236:	84aa                	mv	s1,a0
  p = sbrk(amt);
    2238:	06400537          	lui	a0,0x6400
    223c:	9d05                	subw	a0,a0,s1
    223e:	0d3020ef          	jal	4b10 <sbrk>
  if (p != a) {
    2242:	0aa49463          	bne	s1,a0,22ea <sbrkmuch+0xd4>
  char *eee = sbrk(0);
    2246:	4501                	li	a0,0
    2248:	0c9020ef          	jal	4b10 <sbrk>
    224c:	87aa                	mv	a5,a0
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    226c:	4501                	li	a0,0
    226e:	0a3020ef          	jal	4b10 <sbrk>
    2272:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2274:	757d                	lui	a0,0xfffff
    2276:	09b020ef          	jal	4b10 <sbrk>
  if(c == (char*)0xffffffffffffffffL){
    227a:	57fd                	li	a5,-1
    227c:	08f50163          	beq	a0,a5,22fe <sbrkmuch+0xe8>
  c = sbrk(0);
    2280:	4501                	li	a0,0
    2282:	08f020ef          	jal	4b10 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    228e:	4501                	li	a0,0
    2290:	081020ef          	jal	4b10 <sbrk>
    2294:	84aa                	mv	s1,a0
  c = sbrk(PGSIZE);
    2296:	6505                	lui	a0,0x1
    2298:	079020ef          	jal	4b10 <sbrk>
    229c:	8a2a                	mv	s4,a0
  if(c != a || sbrk(0) != a + PGSIZE){
    229e:	08a49663          	bne	s1,a0,232a <sbrkmuch+0x114>
    22a2:	4501                	li	a0,0
    22a4:	06d020ef          	jal	4b10 <sbrk>
  ...
  a = sbrk(0);
    22c0:	4501                	li	a0,0
    22c2:	04f020ef          	jal	4b10 <sbrk>
    22c6:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    22c8:	4501                	li	a0,0
    22ca:	047020ef          	jal	4b10 <sbrk>
    22ce:	40a9053b          	subw	a0,s2,a0
    22d2:	03f020ef          	jal	4b10 <sbrk>
  if(c != a){
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247e:	692020ef          	jal	4b10 <sbrk>
    sbrk(-sz);
    2482:	40a0053b          	negw	a0,a0
    2486:	68a020ef          	jal	4b10 <sbrk>
    exit(0);
    248a:	4501                	li	a0,0
...
0000000000002528 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    2538:	4501                	li	a0,0
    253a:	5d6020ef          	jal	4b10 <sbrk>
  if((top % 4096) != 0)
    253e:	03451793          	slli	a5,a0,0x34
    2542:	ebad                	bnez	a5,25b4 <sbrklast+0x8c>
  sbrk(4096);
    2544:	6505                	lui	a0,0x1
    2546:	5ca020ef          	jal	4b10 <sbrk>
  sbrk(10);
    254a:	4529                	li	a0,10
    254c:	5c4020ef          	jal	4b10 <sbrk>
  sbrk(-20);
    2550:	5531                	li	a0,-20
    2552:	5be020ef          	jal	4b10 <sbrk>
  top = (uint64) sbrk(0);
    2556:	4501                	li	a0,0
    2558:	5b8020ef          	jal	4b10 <sbrk>
    255c:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
...
00000000000025ca <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    25d8:	538020ef          	jal	4b10 <sbrk>
  volatile char *top = sbrk(0);
    25dc:	4501                	li	a0,0
    25de:	532020ef          	jal	4b10 <sbrk>
  *(top-1) = *(top-1) + 1;
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3960:	1b0010ef          	jal	4b10 <sbrk>
    3964:	064007b7          	lui	a5,0x6400
    3968:	40a7853b          	subw	a0,a5,a0
    396c:	1a4010ef          	jal	4b10 <sbrk>
      write(fds[1], "x", 1);
    3970:	4605                	li	a2,1
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    a = sbrk(0);
    3a38:	4501                	li	a0,0
    3a3a:	0d6010ef          	jal	4b10 <sbrk>
    3a3e:	892a                	mv	s2,a0
    sbrk(10*BIG);
    3a40:	3e800537          	lui	a0,0x3e800
    3a44:	0cc010ef          	jal	4b10 <sbrk>
