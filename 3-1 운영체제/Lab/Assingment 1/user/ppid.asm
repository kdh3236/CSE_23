...
int main() {
   ...
   a:	1000                	addi	s0,sp,32
	int pid = getpid();
   c:	32c000ef          	jal	338 <getpid>
  10:	892a                	mv	s2,a0
	int ppid = getppid();
  12:	32e000ef          	jal	340 <getppid>
  16:	84aa                	mv	s1,a0
	printf("My student ID is 2023065350\n");
  18:	00001517          	auipc	a0,0x1
  1c:	87850513          	addi	a0,a0,-1928 # 890 <malloc+0x104>
  20:	6b8000ef          	jal	6d8 <printf>
	printf("My pid is %d\n", pid);
  24:	85ca                	mv	a1,s2
  26:	00001517          	auipc	a0,0x1
  2a:	88a50513          	addi	a0,a0,-1910 # 8b0 <malloc+0x124>
  2e:	6aa000ef          	jal	6d8 <printf>
	printf("My ppid is %d\n", ppid);
  32:	85a6                	mv	a1,s1
  34:	00001517          	auipc	a0,0x1
  38:	88c50513          	addi	a0,a0,-1908 # 8c0 <malloc+0x134>
  3c:	69c000ef          	jal	6d8 <printf>
}
  40:	4501                	li	a0,0
  42:	60e2                	ld	ra,24(sp)
  44:	6442                	ld	s0,16(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a0:	53c50513          	addi	a0,a0,1340 # 8d8 <digits>
 3a4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 636:	2a6b8b93          	addi	s7,s7,678 # 8d8 <digits>
 ...
 684:	25090913          	addi	s2,s2,592 # 8d0 <malloc+0x144>
        for(; *s; s++)
